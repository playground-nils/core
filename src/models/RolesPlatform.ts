...
export class PlatformRoles {
  ...
  static readonly Anonymous: IRole = {
    ...
    description:
      'A Platform Anonymous is given to an anonymous visitor of the platform who does not have any account.',
  ...
  static readonly Guest: IRole = {
    ...
    description:
      'A Platform Guest to an guest of the platform who eg. has requested access to the platform.',
  ...
  static readonly Member: IRole = {
    ...
    description:
      'A Platform Member is the role given to any member of the platform.',
  ...
  static readonly SecurityAuditor: IRole = {
    ...
    description:
      'A Platform Security Auditor is given to access to create security reviews.',
  ...
  static readonly FeaturesPreviewer: IRole = {
    ...
    description:
      'A Platform Features Previewer can see features before others.',
